...
public abstract class HttpsClient extends SSLConnection {
    ...
    protected int requestTimeout = 500000;
    protected int connectTimeout = 5000;
    protected int socketTimeout = 5000;


    protected void initHttpsClient() throws CertificateException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyStoreException, KeyManagementException, IOException {
...
//        poolClientManage.setMaxPerRoute(new HttpRoute(httpHost), maxRoute);
        ...
        httpClient = HttpClients.custom().setConnectionManager(poolClientManage).setDefaultRequestConfig(requestConfig).setRetryHandler(requestRetry).build();
...
//            ResponseHandler<PaymentProvider> rh = new ResponseHandler<PaymentProvider>() {
//                @Override
//                public PaymentProvider handleResponse(
...
//                    return gson.fromJson(reader, PaymentProvider.class);
//                }
//            };
